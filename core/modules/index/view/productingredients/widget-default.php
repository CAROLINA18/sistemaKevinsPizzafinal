...
<a data-toggle="modal" href="#myModal" class="btn btn-default"><i class="glyphicon glyphicon-plus-sign"></i> <strong>Agregar Ingrediente</strong></a>
<a href="index.php?view=newingredient" class="btn pull-right btn-default"><i class="glyphicon glyphicon-plus-sign"></i> <strong>Nuevo Ingrediente</strong></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><strong>Agregar Ingrediente</strong></h4>
        </div>
        <div class="modal-body">
         <form class="form-horizontal" method="post" action="index.php?view=addproductingredient" role="form">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Ingrediente</strong></label>
    <div class="col-lg-10">
<select name="ingredient_id" class="form-control" required>
  ...
  <div class="form-group">
    <label for="inputPassword1" class="col-lg-2 control-label"><strong>Cantidad</strong></label>
    <div class="col-lg-10">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="product_id" value="<?php echo $_GET["id"];?>">
      <button type="submit" class="btn btn-primary"><strong>Agregar Producto</strong></button>
    </div>
  </div>
</form>
        </div>
...
<form class="form-horizontal" method="post" action="index.php?view=updateproductingredient" role="form">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Producto</strong></label>
    <div class="col-lg-10">
