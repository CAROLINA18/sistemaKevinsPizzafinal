...
-->
<div class ="tithis"><center><h1><?php echo $product->name;; ?> <small><b>Historial</b></small></h1></center></div>
<br>
	</div>
	</div>
<center>
...
<div class="row">
	<div class="col-md-12">
		<?php if(count($operations)>0):?>
			...
			<td><?php echo $product->price_out * $operation->q; ?></td>
<td style="width:40px;"><a href="#" id="oper-<?php echo $operation->id; ?>" class="btn btn-sm btn-danger"><i class='glyphicon glyphicon-trash'></i></a>
			...
			$("#oper-<?php echo $operation->id; ?>").click(function(){
				...
				if(x==true){
					window.location = "index.php?view=deleteoperation&ref=history&id=<?php echo $operation->id;?>";
				}
			});
