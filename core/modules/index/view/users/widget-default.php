...
<div class="btn-group">
  <button type="button" class="btn  btn-default dropdown-toggle" data-toggle="dropdown">
    <i class='glyphicon glyphicon-user'></i> <strong>Nuevo Usuario</strong>
  </button>
  <ul class="dropdown-menu" role="menu">
<!--    <li><a href="index.php?view=newadmin">Nuevo Administrador</a></li> -->
    <li><a href="index.php?view=newcajero"><strong>Nuevo Cajero</strong></a></li>
    <li><a href="index.php?view=newmesero"><strong>Nuevo Mesero</strong></a></li>
  </ul>
</div>
<br>
