...
<div class="box box-solid box-primary">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Codigo*</strong></label>
    <div class="col-md-8">
      <input type="text" name="code" class="form-control" id="name" placeholder="Codigo del Producto">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Nombre*</strong></label>
    <div class="col-md-8">
      <input type="text" name="name" class="form-control" required id="name" placeholder="Nombre del Producto">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Descripcion</strong></label>
    <div class="col-md-8">
      <textarea name="description" class="form-control" id="name" placeholder="Descripcion del Producto"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Peparacion</strong></label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Precio*</strong></label>
    <div class="col-md-8">
      <input type="text" name="price_out" class="form-control " required id="price_out" placeholder="Precio de salida">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Duracion</strong></label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Unidad*</strong></label>
    <div class="col-md-8">
      <input type="text" name="unit" class="form-control " required id="unit" placeholder="Unidad del Producto">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label"><strong>Categoria*</strong></label>
    <div class="col-md-8">
...
<p class="alert alert-info">* Campos obligatorios: Nombre, Precio, Unidad, Categoria</p>
