<section class="content-header">
  <h1><strong>Agregar Ingrediente</strong></h1>
</section>
...
<p class="alert alert-info">* Campos obligatorios: Nombre</p>

  <div class="form-group">
    <div class="col-lg-offset-3 col-lg-9">
      <button type="submit" class="btn btn-primary"><strong>Agregar Ingrediente</strong></button>
    </div>
  </div>
</form>
</div>
