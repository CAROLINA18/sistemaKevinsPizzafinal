...
<div class="row">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Descripcion</strong></label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Peparación</strong></label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Duracion</strong></label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Categoria</strong></label>
    <div class="col-md-6">
...
<p class="alert alert-info">* Campos obligatorios: Nombre, Precio de Salida, Unidad</p>
