	...
	<br>
		<div class="panel panel-default">
        	...
        	<div class="list-group">
					<a href='index.php?view=security' class='list-group-item'><i class="glyphicon glyphicon-chevron-right"></i> <strong>Seguridad y privacidad</strong></a>
			</div>
        </div>
	</div>
	<div class="col-md-8">
...
<br>	<form class="form-horizontal" id="changepasswd" method="post" action="index.php?view=changepasswd" role="form">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label"><strong>Contraseña Actual</strong></label>
    <div class="col-lg-10">
  ...
  <div class="form-group">
    <label for="inputPassword1" class="col-lg-2 control-label"><strong>Nueva Contraseña</strong></label>
    <div class="col-lg-10">
  ...
  <div class="form-group">
    <label for="inputPassword1" class="col-lg-2 control-label"><strong>Confirmar Nueva Contraseña</strong></label>
    <div class="col-lg-10">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-success btn-lg"><strong>Cambiar Contraseña</strong></button>
    </div>
  </div>
</form>
